...
AS $$
BEGIN
    IF NEW.buttoncolor = "RED" THEN
        INSERT INTO Events (ButtonEvent_ID)
        VALUES             (NEW.ID);
    END IF;
	
	IF NEW.buttoncolor = "YELLOW" THEN
		UPDATE Events
...
INSERT INTO ButtonsEvents(ButtonColor, Number)
VALUES (1, 9);
